...
def defaultTextureConfig ():
    ...
    if expecting (['CEILING']):
        ...
        expect ('STAIRS')
        curRoom.defaultTextures['stairs'] = get ()
...
#
# p represents the position, a b and c represent the face normal, this is really handy
# -J
def distance (p, a, b, c):
    d = - (p[0] * a + b * p[1] + c * p[2])
    #print("distance: " + str([p, a, b, c, d]))
    return d

def distanceSpiralStep (p, normal): #returns distance using different inputs for the spiralstep
    a = normal[0]
    b = normal[1]
    c = normal[2]
    d = - (p[0] * a + b * p[1] + c * p[2])
...
def generateWallTorch(p, size, r, o, dir):
    ...
    if dir[0]>0:
        ...
        o.write ('             ( 0 0 1 '+ str(distance([(p[0]-2)*inchesPerUnit, (p[1]-2)*inchesPerUnit, (floor+2)*inchesPerUnit], 0, 0, 1)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('         }\n')
        o.write ('    }\n')
    if dir[1]>0 and dir[0]==0:
        ...
        o.write ('         brushDef3\n')
        o.write ('         {\n')
        o.write ('             ( 1 0 0 '+ str(distance([(p[0]-2)*inchesPerUnit, (p[1]-2)*inchesPerUnit, (p[2])], -1, 0, 0)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('             ( 0 0.96821 -0.25017 '+ str(-distance([(p[0]-2)*inchesPerUnit, (p[1]-2)*inchesPerUnit, (p[2])], 0, 0.96821, 0.25017)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('             ( 0 -0.96821 0.25017 '+ str(distance([(p[0]-2)*inchesPerUnit, (p[1]+size[1]-2)*inchesPerUnit, (p[2])], 0, 0.96821, 0.25017)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('             ( -1 0 0 '+ str(distance([(p[0]+size[0]-2)*inchesPerUnit, (p[1]-2)*inchesPerUnit, (p[2])], 1, 0, 0)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('             ( 0 0 -1 '+ str(distance([(p[0]-2)*inchesPerUnit, (p[1]-2)*inchesPerUnit, (floor + 1) * inchesPerUnit], 0, 0, -1)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('             ( 0 0 1 '+ str(distance([(p[0]-2)*inchesPerUnit, (p[1]-2)*inchesPerUnit, (floor+2)*inchesPerUnit], 0, 0, 1)) +' ) ( ( 0.0078125 0 0 ) ( 0 0.0078125 0 ) ) "textures/hell/wood1" 0 0 0\n')
        o.write ('         }\n')
        o.write ('    }\n')
...
def main ():
    global inputFile, words, toTxt, tempPrims
    io = handleOptions ()
    checkRegression ()
